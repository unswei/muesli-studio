...
- [ ] add URL-stable deep links to a run, tick, node, and view state
- [ ] tighten run-summary surfacing so warnings and unusual event families are obvious before scrubbing
- [ ] keep long runs workable with stronger large-log and lazy-hydration behaviour in the UI

## later roadmap follow-up

- [ ] polish compare mode around aligned structure, divergence emphasis, and restrained motion
